<script>
	...
	// Stores
	import { currentUser, currentUserFollowing, currentUserGroups, currentUserFollowers } from '../stores/user'
...
<div class="mt-10 flex flex-col items-center">
	...
	<div class="p-4 mt-2 border-r-emerald-700 border-8 rounded-xl border-t-red-500 border-l-cyan-600 border-b-orange-400">
