<script>
	...
	const s1 = new URL('../assets/s1.png', import.meta.url).href
	const s2 = new URL('../assets/s2.png', import.meta.url).href
	const s3 = new URL('../assets/s3.png', import.meta.url).href
...
<main>
	<img class="w-40" src={s1} alt="" />
	<img class="w-52" src={s3} alt="" />
